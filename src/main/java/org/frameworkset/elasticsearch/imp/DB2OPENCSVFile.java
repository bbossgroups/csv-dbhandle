 ...
 * @Date 2021/2/1 14:39
 */
public class DB2OPENCSVFile {
    private static Logger logger = LoggerFactory.getLogger(DB2OPENCSVFile.class);

    public static void main(String[] args) {
        //LocalPoolDeployer.addShutdownHook = true;//在应用程序stop.sh时，关闭数据源错误提示
        //启动数据采集
        DB2OPENCSVFile db2file = new DB2OPENCSVFile();
