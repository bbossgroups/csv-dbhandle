 ...
 * @Date 2021/2/1 14:39
 */
public class DB2CSV1File {
    private static Logger logger = LoggerFactory.getLogger(DB2CSV1File.class);

    public static void main(String[] args) {
        //LocalPoolDeployer.addShutdownHook = true;//在应用程序stop.sh时，关闭数据源错误提示
        //启动数据采集
        DB2CSV1File db2file = new DB2CSV1File();
    ...
    public static void scheduleTimestampImportData() {
        ...
        fileFtpOupputConfig.setFileDir("D:\\workspace\\bbossesdemo\\cvs-dbhandle\\excel\\hebin");//数据生成目录
        ...
        fileFtpOupputConfig.setRecordGenerator(new RecordGenerator() {
            ...
            public void buildRecord(Context context, CommonRecord record, Writer builder)throws Exception {
                ...
                strBuilder.append(",")   ;
                strBuilder.append(datas.get("by_year"))   ;
                strBuilder.append(",")   ;
...
//		importBuilder.setIncreamentEndOffset(300);//单位秒
        ...
        importBuilder
                ...
                .setSqlName("querynewmanrequests2");
