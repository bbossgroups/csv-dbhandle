 ...
 * @version 1.0
 */
public class OPENCSVFile2DBDemo {
	private static Logger logger = LoggerFactory.getLogger(OPENCSVFile2DBDemo.class);
...
//				.setExcludeLines(new String[]{"\\[DEBUG\\]"}));//不采集debug日志
		...
		config.addConfig(csvFileConfig.setSourcePath("C:\\workspace\\bbossgroups\\bboss-demos\\etl-elasticsearch\\filelog-elasticsearch\\csvfiles")//指定目录
...
//				.setUsePool(true)//是否使用连接池
        ...
        csvFileConfig.addCellMapping(0, "shebao_org");
        csvFileConfig.addCellMapping(1, "person_no");
        csvFileConfig.addCellMapping(2, "name");
        csvFileConfig.addCellMapping(3, "cert_type");
        csvFileConfig.addCellMapping(4, "cert_no");
        csvFileConfig.addCellMapping(5, "zhs_item");
        csvFileConfig.addCellMapping(6, "zhs_class");
        csvFileConfig.addCellMapping(7, "zhs_sub_class");
        csvFileConfig.addCellMapping(8, "zhs_year","");
        csvFileConfig.addCellMapping(9, "zhs_level","");
		/**
		 * 重新设置es数据结构
		 */
